...
{
    public partial class ChDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimimAgents", x => x.AgentId);
                });

            migrationBuilder.CreateTable(
                name: "TimimProperties",
                columns: table => new
                {
                    ...
                    TransactionPurpose = table.Column<int>(type: "int", nullable: false),
                    ...
                    NoOfLivingRoom = table.Column<int>(type: "int", nullable: false),
                    ...
                    PropertySize = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Street = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    LocalGovernmentArea = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    WaterSupply = table.Column<bool>(type: "bit", nullable: false),
                    PowerBackup = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    PublicTransitAccess = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    VirtualTourLink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    VideoLink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    RegisterPersonnelCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContactNumber = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    ContactEmail = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    PropertyImage1 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    PropertyImage2 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    PropertyImage3 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DocumentOnProperty = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimimProperties", x => x.PropertyId);
                });

            migrationBuilder.CreateTable(
                name: "TimimTransactions",
                columns: table => new
                {
                    ...
                    OtherMeansOfIdentification = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimimTransactions", x => x.TransactionId);
                });
